...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. Creamos una instancia de nuestra Pantalla.
        //    (El constructor de Pantalla se encargará de crear el Gestor y los DAOs)
        Pantalla pantallaPrincipal = new Pantalla();
